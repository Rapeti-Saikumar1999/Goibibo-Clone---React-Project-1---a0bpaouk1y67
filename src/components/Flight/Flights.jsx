    ...
    <div className="flights-container">
        ...
        <form action="" className="details" onSubmit={handleSubmit}>
            <div className="radio-buttons">
                ...
                <div className="each-radio-button" style={{ cursor: "not-allowed" }}>
            ...
            <div className="journeyinfo">
                <input type="text" name="" id="" value={source} onChange={(e)=>setSource(e.target.value)} placeholder='Enter Source...(HYD)'/>
                <input type="text" name="" id="" value={destination} onChange={(e)=>setDestination(e.target.value)} placeholder='Enter Destination...(BOM)'/>
