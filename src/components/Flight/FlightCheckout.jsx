...
const state = loc.state;
  ...
  const Handlesubmit =(e)=>
  {
    ...
    {
      Navigate("/flights/payment", {state:{details,FirstName,LastName,PhoneNo,Country,Email,Type}})
    }
    else{
    ...
    <div className="checkout-container">
      ...
      <div className="checkout-info">
        ...
        <div>
          ...
          <input type="text" name="" id="" placeholder="Enter First Name" value={FirstName} onChange={(e)=>setFirstName(e.target.value)}/>
        </div>
        <div>
          <label htmlFor="">Last Name</label>
          <input type="text" name="" id="" placeholder="Enter Last Name" value={LastName} onChange={(e)=>setLastName(e.target.value)}/>
        </div>

        <div>
          <label htmlFor="">Country</label>
          <input type="text" name="" id="" placeholder="Enter Your Country" value={Country} onChange={(e)=>setCountry(e.target.value)}/>
        </div>
        ...
        <div>
          ...
          <input type="tel" name="" id="" placeholder="Enter Phone Number" value={PhoneNo} onChange={(e)=>setPhoneNo(e.target.value)}/>
        </div>
