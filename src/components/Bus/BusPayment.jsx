      ...
      <div className="flight-user-details">
        <div className="payment-flight-details">
          <div className="airline-details">
            <h2 style={{ color: "red" }}>{state.bus.name}</h2>
          ...
          <div className="payment-flight-info">
            <div>
              ...
              <div>
                <p>Source:{state.bus.source}</p>
                <p>Arraival Time:{state.bus.arrivalTime}</p>
                <p>Destination:{state.bus.destination}</p>
                <p>Departure Time:{state.bus.departureTime}</p>
